...
// js file paths
var utilJsPath = "node_modules/codyhouse-framework/assets/js"; // util.js path - you may need to update this if including the framework as external node module
...
function moveAssets() {
  return new Promise(function (resolve, reject) {
    var stream = gulp
      .src(["assets/img/**"], { allowEmpty: true })
