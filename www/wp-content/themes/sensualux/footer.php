    ...
    <div class="footer-v3__container container max-width-lg">
      ...
      <nav class="footer-v3__nav">
        <ul class="footer-v3__nav-list">
          <li class="footer-v3__nav-item"><a href="#product" class="footer-v3__link">Product</a></li>
          <li class="footer-v3__nav-item"><a href="#learn" class="footer-v3__link">Learn</a></li>
          <li class="footer-v3__nav-item"><a href="#testimonials" class="footer-v3__link">Testimonials</a></li>
          <li class="footer-v3__nav-item"><a href="#pricing" class="footer-v3__link">Pricing</a></li>
        </ul>
      </nav>
