...
class Couple
{
     ...
     *
     * @param int $user1_id The ID of the first user in the couple.
     * @param int $user2_id The ID of the second user in the couple.
     * @return Couple The newly created Couple object.
     */
    public static function create(int $user1_id, int $user2_id): Couple
    {
        ...
        $couple = new self($couple_id, $user1_id, $user2_id);
