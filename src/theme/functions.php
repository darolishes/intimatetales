...
function intimate_tales_enqueue_styles_scripts() {
    wp_enqueue_style( 'intimate-tales-style', get_template_directory_uri() . '/assets/css/style.min.css' );

    wp_enqueue_script( 'intimate-tales-color-theme', get_template_directory_uri() . '/assets/js/color-theme.js', array(), null, true );
    wp_enqueue_script( 'intimate-tales-scripts', get_template_directory_uri() . '/assets/js/scripts.min.js', array('jquery'), null, true );
}
