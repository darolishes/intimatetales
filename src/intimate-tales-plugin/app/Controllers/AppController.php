...
class AppController
{
	...
	public function __construct(PluginConfig $config, Loader $loader)
	{
		$this->config = $config;
		$this->loader = $loader;
	...
	private function define_acf_hooks()
	{
		...
		$this->loader->add_filter('acf/json/save_paths', $acf_handler, 'save_paths', 10, 2);
		$this->loader->add_filter('acf/json/save_file_name', $acf_handler, 'save_file_name', 10, 3);
	}
